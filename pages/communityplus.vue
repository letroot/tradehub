      ...
      <div class="text-blue flex flex-col lg:flex-row justify-between">
        <div class="lg:w-6/12">
          <h1
            ...
            "
          >
            Begin your Journey to Consistent Profitable Trading for Free!
          </h1>
          <h2
            class="
              mt-6
            ...
            "
          >
            Trade your way to financial freedom: increase your income and
            earnings with proven trading strategies all for free.
            <br />
            <br />
            Hi, I'm Joe, an experienced financial market trader for prop firms and high net
            worth individuals.
            <br /><br />
            I'm passionate about giving back to the trading community and so I'm
            inviting you to my result-oriented community of traders on
            Telegram, for free.
          </h2>
...
export default {
  head() {
    return {
      title:
        'Join the Fastest Growing Financial Trader Community :: Joe Elite TradeHub',
    }
  },
}
</script>
